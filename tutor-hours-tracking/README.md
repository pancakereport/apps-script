...
1. Make a copy of the Set Up Tutor Timesheets file and fill out the variables. Making a copy of the file will also copy over the App Script.  
    Note 1: it will not rename the app script. I suggest renaming the app script to something like “tutor hours overall set up SEMESTER.”  
    Note 2: It is important that the individual sheets keep their names (“Semester” and “Courses”) and that the variable names are not edited; these are used by the script specifically.
